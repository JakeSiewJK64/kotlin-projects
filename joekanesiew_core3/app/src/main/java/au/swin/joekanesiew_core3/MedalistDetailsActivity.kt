...
class MedalistDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val medalistSharePrefs =
            getSharedPreferences(MedalistContants.MEDALLISTS_SHARE_PREFS, MODE_PRIVATE)
        val medalistTextView: TextView = findViewById(R.id.medalistDetailsName)

        // retrieves the values from share pref file.
        medalistSharePrefs.apply {
            val shareName: String =
                getString("[DATA]:PREVIOUS_MEDALIST_NAME", null).toString()
            val shareIOC: String = getString("[DATA]:PREVIOUS_MEDALIST_IOC", null).toString()
