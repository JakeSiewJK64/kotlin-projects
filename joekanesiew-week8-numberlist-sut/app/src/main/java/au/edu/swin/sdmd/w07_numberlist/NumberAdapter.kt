...
class NumberAdapter(private val data: List<Int>, private val context: Context) :
    ...
    inner class ViewHolder(private val v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bind(item: Int) {
            ...
            v.setOnClickListener {
                val i = Intent(context, NumberDetails::class.java)
                i.putExtra("MY_NUMBER", item.toString())
